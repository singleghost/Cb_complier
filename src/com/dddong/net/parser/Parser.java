...
//用户定义的类型
    ...
    static public void main(String[] sourceFiles) {
        for (String sourceFile : sourceFiles) {
            try {
                ...
                parseFile(file, libraryLoader, errorHandler, true);
            } catch (Exception ex) {
  ...
  final public UndefinedVariable vardecl() throws ParseException {
    ...
    String name;
      ...
      type = type();
      name = name();
        {if (true) return new UndefinedVariable(type, name);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public UndefinedFunction funcdecl() throws ParseException {
    ...
    Params params;
      ...
      jj_consume_token(47);
        ...
        {if (true) return new UndefinedFunction(false, new TypeNode(funcTypeRef), name, params);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public String import_stmt() throws ParseException {
    ...
    String partname;
      ...
      jj_consume_token(49);
        {if (true) return libname.toString();}
    throw new Error("Missing return statement in function");
    } finally {
...
/* 定义函数部分 */
  ...
  final public Params fixedparams() throws ParseException {
    ...
    Location loc;
      ...
      while (true) {
        ...
        {if (true) return new Params(loc, cbcParams);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public UnionNode defunion() throws ParseException {
    ...
    List<Slot> slots;
      ...
      slots = member_list();
      jj_consume_token(49);
        {if (true) return new UnionNode(location(t), new UnionTypeRef(name), name, slots);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public Slot slot() throws ParseException {
    ...
    String name;
      typenode = type();
      name = name();
        {if (true) return new Slot(typenode, name);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("slot");
    }
  ...
  final public TypedefNode typedef() throws ParseException {
    ...
    Token t, nameToken;
      ...
      jj_consume_token(49);
        ...
        {if (true) return new TypedefNode(location(t), typeref, name);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public TypeNode type() throws ParseException {
    ...
    TypeRef typeref;
      typeref = typeref();
        {if (true) return new TypeNode(typeref);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("type");
    }
  ...
  final public TypeRef typeref() throws ParseException {
    ...
    ParamTypeRefs param_typerefs;
      ...
      if (jj_2_9(2)) {
        jj_consume_token(55);
        jj_consume_token(56);
                             typeRef = new ArrayTypeRef(baseType);
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case 55:
          jj_consume_token(55);
          ...
          jj_consume_token(56);
                            typeRef = new ArrayTypeRef(baseType, integerValue(t.image));
          break;
        case 57:
          jj_consume_token(57);
            typeRef = new PointerTypeRef(baseType);
          break;
        case 46:
          jj_consume_token(46);
          param_typerefs = param_typerefs();
          jj_consume_token(47);
                                                 typeRef = new FunctionTypeRef(baseType, param_typerefs);
          break;
        default:
          jj_la1[10] = jj_gen;
          jj_consume_token(-1);
  ...
  final public ParamTypeRefs fixedparam_typerefs() throws ParseException {
    ...
    Location loc;
      ...
      while (true) {
        ...
        {if (true) return new ParamTypeRefs(loc, typerefs, false);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public LabelNode labeled_stmt() throws ParseException {
    ...
    StmtNode stmt;
      ...
      jj_consume_token(58);
      stmt = stmt();
        {if (true) return new LabelNode(label, stmt);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public DoWhileNode dowhile_stmt() throws ParseException {
    ...
    ExprNode expr;
      ...
      expr = expr();
      jj_consume_token(47);
        {if (true) return new DoWhileNode(location(t), block, expr);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public SwitchNode switch_stmt() throws ParseException {
    ...
    Token t;
      ...
      jj_consume_token(54);
        {if (true) return new SwitchNode(location(t), switchExpr, caseNodeList);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public CaseNode case_clause() throws ParseException {
    ...
    StmtNode stmt;
      ...
      while (true) {
        ...
        {if (true) return new CaseNode(caseExprs.get(0).location(), caseExprs, new BlockNode(stmts.get(0).location() ,null ,stmts));}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public CaseNode default_clause() throws ParseException {
    ...
    List<StmtNode> stmts;
      ...
      jj_consume_token(58);
      stmts = stmts();
        {if (true) return new CaseNode(location(t), null, new BlockNode(stmts.get(0).location(), null, stmts));}
    throw new Error("Missing return statement in function");
    } finally {
...
//switch 语句相关的结束
  ...
  final public GotoNode goto_stmt() throws ParseException {
    ...
    String labelName;
      ...
      labelName = label();
      jj_consume_token(49);
        {if (true) return new GotoNode(location(t), labelName);}
    throw new Error("Missing return statement in function");
    } finally {
...
//if 语句，lookahead 是为了解决空悬 else 的问题，else 属于最近的 if 语句
  ...
  final public ForNode for_stmt() throws ParseException {
    ...
    StmtNode bodyStmt;
      ...
      jj_consume_token(47);
      bodyStmt = stmt();
        {if (true) return new ForNode(location(t), init, cond, action, bodyStmt);}
    throw new Error("Missing return statement in function");
    } finally {
    ...
    ExprNode retValueExpr = null;
      if (jj_2_18(2)) {
        ...
        case RETURN:
          ...
          jj_consume_token(49);
        {if (true) return new ReturnNode(location(t), retValueExpr);}
          break;
        default:
          jj_la1[26] = jj_gen;
          jj_consume_token(-1);
    ...
    TypeNode t;
      ...
      default:
        ...
        if (jj_2_22(3)) {
          ...
          t = type();
          jj_consume_token(47);
        {if (true) return new SizeofTypeNode(t, typeOf_sizeof());}
        } else {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case SIZEOF:
            jj_consume_token(SIZEOF);
            n = unary();
        {if (true) return new SizeofExprNode(n, typeOf_sizeof());}
            break;
          case STRING:
          case CHARACTER:
          case INTEGER:
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x6600000,0x6600000,0x0,0x0,0x4600000,0x0,0x0,0x0,0x1000000,0x0,0x0,0x1f0000,0x10600000,0x0,0xa0008400,0x0,0xa0008400,0x0,0x0,0x0,0xa0008400,0x40000000,0x8400,0x8400,0x8400,0x8400,0x0,0x8400,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8400,0x0,0x8400,0x0,0x0,0x0,0x8400,0x8400,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x200,0x200,0x400,0x10000,0x200,0x40000,0x80000,0x40000,0x0,0x80000,0x2804000,0x0,0x0,0x80000,0x22279fc,0x20000,0x22079fc,0x1,0x2,0x1,0x22279fc,0x0,0x2007800,0x2007800,0x2007800,0x2007800,0x20,0x2007800,0xf8000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000000,0x2000000,0x2007800,0x2000000,0x7800,0x814000,0x814000,0x80000,0x2007800,0x7000,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x7990000,0x0,0x7990000,0x0,0x0,0x0,0x7990000,0x0,0x7990000,0x7990000,0x7990000,0x7990000,0x0,0x7990000,0x1f,0x20,0x40,0x80,0x3f00,0x3f00,0x4000,0x8000,0x10000,0x60000,0x60000,0x180000,0x180000,0x600000,0x600000,0x7990000,0x7990000,0x0,0x9800000,0x9800000,0x0,0x7990000,0x0,};
   }
